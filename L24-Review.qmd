...
These data are not necessarily a random sample of the population, so questions like "does weight change with age?" won't result in conclusions that apply to the general population. However, you can do a couple of tests just to practice your skills. I'll provide the code and the research question, you should provide justifications for using that test, check the assumptions and provide conclusions in the context of the problem. For each question, I've added som plots below.
