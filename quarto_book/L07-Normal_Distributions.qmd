...
I have created a shiny app that lets you explore these calculations^[If you're curious, yes I've made a lot of Shiny apps. You can find them all here: [https://github.com/DBecker7/DB7_TeachingApps](https://github.com/DBecker7/DB7_TeachingApps)]. Feel free to use this to answer the questions in this lecture, and then double check the answers with the z-table. 
