...
The code required to create the bar chart can be shown by clicking the ">Code" icon. 
...
2. Which of the following plots would be appropriate for the `bmi` column?
